...
echo -e "   ${YELLOW}kubectl port-forward service/loan-buddy-agent 8888:8080 -n workshop${NC}"
echo ""
...
echo -e "   ${YELLOW}curl -X POST -F \"image_file=@./example1.png\" http://localhost:8888/api/process_credit_application_with_upload${NC}"
echo ""
